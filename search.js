...
<div class="w3-content" style="max-width:1100px;">
    ...
    <div class="w3-row-padding">
        <div class="w3-half w3-margin-bottom">
            <img src="iguazu.jpg" alt="Norway" style="width:100%">
        ...
        <div class="w3-half w3-margin-bottom">
            <img src="christredeemer.jpg" alt="Germany" style="width:100%">
            <div class="w3-container w3-white">
        ...
        <div class="w3-row-padding">
            <div class="w3-half w3-margin-bottom">
                <img src="lencois.jpg" alt="Norway" style="width:100%">
                <div class="w3-container w3-white">
            ...
            <div class="w3-half w3-margin-bottom">
                <img src="beco.jpg" alt="Germany" style="width:100%">
                <div class="w3-container w3-white">
